...
require (
	...
	github.com/hyperledger/aries-framework-go v0.1.5-0.20201129230829-38376cc15c5a
	github.com/hyperledger/aries-framework-go/component/storage/jsindexeddb v0.0.0-20201129230829-38376cc15c5a
