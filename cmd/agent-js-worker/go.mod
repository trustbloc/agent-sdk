...
require (
	...
	github.com/hyperledger/aries-framework-go v0.1.5-0.20201118151415-d7623b88ae7e
	github.com/hyperledger/aries-framework-go/component/storage/jsindexeddb v0.0.0-20201118151415-d7623b88ae7e
