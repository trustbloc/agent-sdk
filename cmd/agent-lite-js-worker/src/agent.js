...
const Agent = function (opts) {
    ...
    const instance = {
        ...
        */
        ...
        didclient: {
             ...
             * @returns {Promise<Object>}
             */
            resolveOrbDID: async function (req) {
                return invoke(aw, pending, this.pkgname, "ResolveOrbDID", req, "timeout while resolving orb did")
            },
        ...
        mediatorclient: {
             ...
             */
            connect: async function (req) {
                return invoke(aw, pending, this.pkgname, "Connect", req, "timeout while connecting to mediator")
            },
    ...
    var aw = loadWorker(
        ...
        {
            dir: opts.assetsPath,
            wasm: opts.assetsPath + "/agent-lite-js-worker.wasm",
