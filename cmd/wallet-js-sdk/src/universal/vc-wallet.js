...
export class UniversalWallet {
     ...
     */
    async connect(auth, invitation = {}, {myLabel, routerConnections=[], reuseConnection, reuseAnyConnection = false, timeout} = {}) {
     ...
     */
    async proposePresentation(auth, invitation = {}, {myLabel, routerConnections, reuseConnection, reuseAnyConnection = false, connectionTimeout},
                              {from, timeout} = {}) {
