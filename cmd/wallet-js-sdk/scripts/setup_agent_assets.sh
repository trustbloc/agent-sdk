...
if [[ $(grep "@trustbloc-cicd/agent-sdk-web" "package.json") ]] ; then
  ...
  cp -Rp node_modules/@trustbloc-cicd/agent-sdk-web/dist/assets/agent-vcwallet-js-worker.wasm.gz public/agent-js-worker/assets
else
  echo "finding asset in trustbloc/"
  cp -Rp node_modules/@trustbloc/agent-sdk-web/dist/assets/* public/agent-js-worker/assets
  cp -Rp node_modules/@trustbloc/agent-sdk-web/dist/assets/agent-vcwallet-js-worker.wasm.gz public/agent-js-worker/assets
fi
