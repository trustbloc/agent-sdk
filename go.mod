...
require (
	...
	github.com/hyperledger/aries-framework-go v0.1.5-0.20201207174605-8e3674244a19
	github.com/hyperledger/aries-framework-go/component/storage/jsindexeddb v0.0.0-20201207174605-8e3674244a19
